...
2. Comparte un enlace `computer://` directo al PDF final dentro de la carpeta del usuario.
3. Mantén la respuesta breve — el usuario puede abrir el archivo para revisarlo.
